...
db.session.add(Fill(question="A tree is made from", module_code="Fruit123", correct="wood", blank=" ", difficulty="easy",
    date_created=" ", is_formative=False, feedback="Refer to Fruit123 module!"))
db.session.commit()
db.session.add(Fill(question="1 + 299 = 300", module_code="Maths123", correct="300", blank=" ", difficulty="hard", date_created=" ", is_formative=True, feedback="Refer to Maths123 notes, Chapter 2"))
db.session.commit()
